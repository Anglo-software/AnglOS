...
.PHONY: run
run: angl-os.iso
	qemu-system-x86_64 -M q35 -m 8G -cdrom angl-os.iso -boot d

.PHONY: run-uefi
run-uefi: ovmf-x64 angl-os.iso
	qemu-system-x86_64 -M q35 -m 8G -bios ovmf-x64/OVMF.fd -cdrom angl-os.iso -boot d

.PHONY: run-hdd
run-hdd: angl-os.hdd
	qemu-system-x86_64 -M q35 -m 8G -hda angl-os.hdd

.PHONY: run-hdd-uefi
run-hdd-uefi: ovmf-x64 angl-os.hdd
	qemu-system-x86_64 -M q35 -m 8G -bios ovmf-x64/OVMF.fd -hda angl-os.hdd
