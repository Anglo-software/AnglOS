...
#define GDT_BASIC_DESCRIPTOR                             \
    (GDT_DESCRIPTOR_PRESENT | GDT_DESCRIPTOR_READWRITE | \
     GDT_DESCRIPTOR_CODE_DATA)
#define GDT_BASIC_GRANULARITY    (GDT_GRANULARITY_X64 | GDT_GRANULARITY_4K)

#define GDT_OFFSET_KERNEL_CODE16 (0x01 * 0x08)
#define GDT_OFFSET_KERNEL_DATA16 (0x02 * 0x08)
#define GDT_OFFSET_KERNEL_CODE32 (0x03 * 0x08)
...
void gdtReload(gdtr_t* gdtr, uint16_t code, uint16_t data);
