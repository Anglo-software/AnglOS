...
struct list_elem* list_begin(struct list* list) { return list->head.next; }

/* Returns the element after ELEM in its list.  If ELEM is the
   last element in its list, returns the list tail.  Results are
   undefined if ELEM is itself a list tail. */
struct list_elem* list_next(struct list_elem* elem) { return elem->next; }
...
/* Returns LIST's tail.
   ...
   an example. */
struct list_elem* list_end(struct list* list) { return &list->tail; }

/* Returns the LIST's reverse beginning, for iterating through
   LIST in reverse order, from back to front. */
struct list_elem* list_rbegin(struct list* list) { return list->tail.prev; }

/* Returns the element before ELEM in its list.  If ELEM is the
   first element in its list, returns the list head.  Results are
   undefined if ELEM is itself a list head. */
struct list_elem* list_prev(struct list_elem* elem) { return elem->prev; }
...
*/
struct list_elem* list_rend(struct list* list) { return &list->head; }
...
*/
struct list_elem* list_head(struct list* list) { return &list->head; }

/* Return's LIST's tail. */
struct list_elem* list_tail(struct list* list) { return &list->tail; }
...
struct list_elem* list_front(struct list* list) { return list->head.next; }

/* Returns the back element in LIST.
   Undefined behavior if LIST is empty. */
struct list_elem* list_back(struct list* list) { return list->tail.prev; }
